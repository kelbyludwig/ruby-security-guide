...
There are also class instance variables, that's right! To read more about them
see Martin Fowler's
...
by annotating the last argument with an &, we are converting the supplied block
